...
`Shortify` – небольшая консольная утилита, позволяющая преобразовывать длинные URL‑адреса в короткие ссылки. Проект создан в учебных целях и демонстрирует навыки работы с Go, Docker, базой данных и логированием, экспериментов с нагрузкой.
